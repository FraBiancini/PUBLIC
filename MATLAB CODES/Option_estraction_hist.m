function [mkt]=Option_estraction_hist(title,namefile_spot,tresh_bid_ask,tresh_penny,DK)
%% Call vs Put
...
for i=1:length(Maturity)
    ...
    valid_prices=index4(find((Put(index4,2)>tresh_penny*DK).*(Call(index4,2)>tresh_penny*DK)));
